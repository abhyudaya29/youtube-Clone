...
const Head = () => {
  ...
  return (
    <>
    <div className={isDarkTheme?`grid grid-flow-col p-5 m-2 shadow-lg rounded-lg bg-slate-800 transition-colors duration-500`:`grid grid-flow-col p-5 m-2 shadow-lg rounded-sm transition-colors duration-500`}>
